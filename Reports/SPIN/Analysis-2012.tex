...
\begin{document}
\title{Estimation of the total cross section and cross section asymmetry a transmission experiment}
...
\begin{abstractname}
 In this contribution we describe a possible procedure for estimating the total unpolarized cross section and cross section asymmetry from measurements of average beam current. We also present the estimates obtained for the cross sections $\CS[0]^{pp}$ and $\CS[0]^{pd}$ in the cases of $pp$ and $pd$ scattering, as well as the asymmetry $\Ayy$ in double-polarized $\vec{p}\vec{p}$ scattering, from data collected in September 2012 and June 2016 at the cooler synchrotron COSY-J\"ulich in the course of a preliminary experiment to the test of Time-Reversal Invariance at COSY (TRIC). 
\end{abstractname}
