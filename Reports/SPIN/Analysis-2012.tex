...
Our best estimate for the $pp$ cross section is $507 \pm 7$ a.u., that for the $pd$ reaction is $411 \pm 48$. The asymmetry $\Ayy = \vp{(5 \pm 3)}{-2}$. %FIG.~\ref{fig:AyyDensity} shows its Gaussian kernel density estimate.
...
\centering
	...
	\end{subfigure}
		\begin{subfigure}{.5\textwidth}
			...
			\caption{2016.}
		\end{subfigure}
\caption{Cross section estimates plotted against their off-cycle number.}
\end{figure}
\begin{figure}
	\centering
\begin{subfigure}{.5\textwidth}
