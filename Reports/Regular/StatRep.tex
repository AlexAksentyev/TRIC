...
\begin{table}[h]
\centering
\caption{For Figure~\ref{fig:SEAyy_varb}\label{tbl:SEAyy_varb}}
\begin{tabular}{lrr}
\hline\hline
...
%\]	
%and we can estimate $\bkt{\v{\slp}}(h) = \sfrac 1h \sum_{i=1}^{h}(\slp[i] - \avg{\slp})^2$.
%
%\begin{figure}
%\includegraphics[scale=1]{varb_ThickDissip}
%\end{figure}
