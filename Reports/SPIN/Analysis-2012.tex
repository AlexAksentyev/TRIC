...
This reduces the number of estimates from 20 to seven. By looking at FIG.~\ref{fig:SlpOnI02016}, one might hypothesize that beam current plays a significant role in predicting the slope.
...
\end{subfigure}
\caption{Slope estimates plotted against initial beam current.}
\end{figure}
